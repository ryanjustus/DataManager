...
public class MicrosoftSQL {
    ...
    public void setUp() throws ClassNotFoundException {
        ...
        Connection con=null;
        try{
            con = DriverManager.getConnection(dbUrl+"user="+dbUser+";password="+dbPass+";");
            Statement stmt = con.createStatement();
            stmt.execute("IF EXISTS(SELECT name FROM  sys.databases WHERE name = '"+database+"')"+
    ...
    public void testBuildSchemas() {
        ...
        dm.logDebug("VENDOR: " +dm.getDatabaseSchema().getAttr(SqlDatabaseSchema.DatabaseSchemaAttr.Vendor));
    ...
    */
    ...
    public void testDates() throws ParseException {
        ...
        try{
            ...
            dm.addData("test_date", "c_datetime", timestamp);
            dm.commit("test_date");
            dm.flush();
            try {
                con = dm.getConnection();
                ...
                assertEquals(rs.getTimestamp("c_datetime"), new java.sql.Timestamp(fDateTime.parse(timestamp).getTime()));
            ...
            dm.addData("test_date", "c_datetime", now);
            dm.commit("test_date");
            dm.flush();
            con = null;
            try {
                ...
                assertTrue(now-rs.getTimestamp("c_datetime").getTime()<1000);
    ...
    public void testPriceInsert(){
     ...
     /**
     * Test adding a DateTimeOffset which is a non-jdbc defined type
     */ 
    @Test
    public void testDateTimeOffset() {
        ...
        try{
            ...
            System.out.println("add data");
            String payload = "2011-11-07 12:43:11.3120000 -07:00";
            //Do initial insert using case insentivity for tables and columns
            dm.addData("test_main", "data", payload);
            dm.commit("test_main");
            dm.flush();
